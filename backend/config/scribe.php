...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by registering or logging in via the auth endpoints. Use the token in the Authorization header as: `Bearer {token}`.',
    ],
    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                // Enable response calls for all methods to get proper examples
                config: [
                    'app.debug' => false,
                ]
            )
